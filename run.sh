...
dnf update -y && dnf install -y git make cmake ccache tar gzip unzip python3-jupyter-core python3-nbconvert \
                   ...
                   python3-mpi4py-openmpi libasan libubsan lcov python3-ddt python3-yaml python3-devel \
...
python3 -m pip install vtk # dnf python3-vtk is old and not maintained by Kitware
